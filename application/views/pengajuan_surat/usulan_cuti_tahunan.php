<nav class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Usulan Cuti Tahunan</li>
    </ol>
</nav>
...
<div class="card">
    <div class="card-header">
        <h3><iconify-icon icon="mdi:file-document-edit-outline" class="mr-2"></iconify-icon>Form Usulan Cuti Tahunan</h3>
    </div>
    <div class="card-body">
        ...
        <form action="<?= site_url('pengajuan_surat/simpan_usulan_cuti_tahunan') ?>" method="POST" id="formUsulanCutiTahunan">
            <div class="form-row">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary" onclick="confirmSubmitUsulan('formUsulanCutiTahunan', 'Usulan Cuti Tahunan')">
